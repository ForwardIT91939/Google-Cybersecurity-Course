...
Output for both are from the stored variable.
...
After inputting the print function, we can see that some IP addresses do
show up from the remove_list.
...
This will be easier to call upon later.
...
Although there were some difficulties, I was able to learn the use of
variables and creating a algorithm that will help me in the future.
